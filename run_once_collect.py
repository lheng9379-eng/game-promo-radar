...
from game_promo_radar.discovery import run_all as run_discovery_all
...
def main() -> int:
    ...
    print(f"  新增候选商机：{discovery.new_candidate_count}")
    print(f"  更新候选商机：{discovery.updated_candidate_count}")
